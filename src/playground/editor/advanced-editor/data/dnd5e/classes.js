...
const classes = [
  {
    ...
    hp: [
      '每野蛮人等级 1d12',
      '12＋你的体质调整值',
      '首级生命值之外，对应每个野蛮人等级 7（1d12）＋你的体质调整值',
    ],
    proficiencies: [
      '轻甲、中甲、盾牌',
      '简易武器、军用武器',
  ...
  },
  {
    ...
    hp: [
      '每吟游诗人等级 1d8',
      '8＋你的体质调整值',
      '首级生命值外，对应每个吟游诗人等级 5（1d8）＋你的体质调整值',
    ],
    proficiencies: [
      '轻甲',
      '简易武器、手弩、长剑、刺剑、短剑',
  ...
  },
  {
    ...
    hp: [
      '每牧师等级 1d8',
      '8＋你的体质调整值',
      '首级生命值之外，对应每个牧师等级 5（1d8）＋ 你的体质调整值',
    ],
    proficiencies: [
      '轻甲、中甲、盾牌',
      '简易武器',
  ...
  },
  {
    ...
    hp: [
      '每德鲁伊等级 1d8',
      '8＋你的体质调整值',
      '首级生命值之外，对应每德鲁伊等级 5（1d8）＋ 你的体质调整值',
    ],
    proficiencies: [
  ...
  },
  {
    ...
    hp: [
      '每战士等级 1d10',
      '10＋你的体质调整值',
      '首级生命值之外，对应每个战士等级 6（1d10）＋ 你的体质调整值',
    ],
    proficiencies: [
      '全部护甲、盾牌',
      '简易武器、军用武器',
  ...
  },
  {
    ...
    hp: [
      '每武僧等级 1d8',
      '8＋你的体质调整值',
      '首级生命值之外，对应每个武僧等级 5（1d8）＋ 你的体质调整值',
    ],
    proficiencies: [
      '无',
      '简易武器、短剑',
  ...
  },
  {
    ...
    hp: [
      '每圣武士等级 1d10',
      '10＋你的体质调整值',
      '首级生命值之外，对应每个圣武士等级 6（1d10）＋你的体质调整值',
    ],
    proficiencies: [
      '所有护甲和盾牌',
      '简易武器和军用武器',
  ...
  },
  {
    ...
    hp: [
      '每游侠等级 1d10',
      '10＋你的体质调整值',
      '首级生命值之外，对应每个游侠等级 6（1d10）＋你的体质调整值',
    ],
    proficiencies: [
      '轻甲、中甲、盾牌',
      '简易武器、军用武器',
  ...
  },
  {
    ...
    hp: [
      '每游荡者等级 1d8',
      '8＋你的体质调整值',
      '首级生命值之外，对应每个游荡者等级 5（1d8）＋你的体质调整值',
    ],
    proficiencies: [
      '轻甲',
      '简易武器、手弩、长剑、刺剑、短剑',
  ...
  },
  {
    ...
    hp: [
      '每术士等级 1d6',
      '6＋你的体质调整值',
      '首级生命值之外，对应每一个术士等级 4（1d6）＋你的体质调整值',
    ],
    proficiencies: [
      '无',
      '匕首、飞镖、投石索、长棍、轻弩',
  ...
  },
  {
    ...
    hp: [
      '每邪术师等级 1d8',
      '8＋你的体质调整值',
      '首级生命值之外，对应每个邪术师等级 5（1d8）＋你的体质调整值',
    ],
    proficiencies: [
      '轻甲',
      '简易武器',
  ...
  },
  {
    ...
    hp: [
      '每法师等级 1d6',
      '6＋你的体质调整值',
      '首级生命值之外，对应每个法师等级 4（1d6）＋ 你的体质调整值',
    ],
    proficiencies: [
      '无',
      '匕首、飞镖、投石索、长棍、轻弩',
