...
// fork from https://github.com/zo0r/react-native-push-notification/blob/6a6e9514c4/android/src/main/java/com/dieam/reactnativepushnotification/modules/RNPushNotificationHelper.java
// 移除了计划任务
...
import static com.moonrailgun.trpg.TRPGModule.LOG_TAG;
// import static com.dieam.reactnativepushnotification.modules.RNPushNotificationAttributes.fromJson;

public class TRPGNotificationHelper {
    ...
    public TRPGNotificationHelper(Application context) {
        this.context = context;
        this.scheduledNotificationsPersistence = context.getSharedPreferences(TRPGNotificationHelper.PREFERENCES_KEY, Context.MODE_PRIVATE);
    }
    ...
    private void checkOrCreateChannel(NotificationManager manager) {
        ...
        NotificationChannel channel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "local-notification-channel", importance);

        // channel.setDescription(this.config.getChannelDescription());
        channel.setDescription("本地推送");
